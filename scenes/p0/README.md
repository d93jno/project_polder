...
- **`CameraTactical`** — 25° perspective (UI §2 working default), rest looks +X down the street, pitched so dikes and roofs both read. Duplicate node name and transform in both scenes for A/B projection tests. 90° snap; peek yaw is not implemented.
