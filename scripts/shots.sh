...
SETUPS=(street_watch street_ap_spent street_yaw180 terrace_flooded terrace_falling terrace_roof_cutaway terrace_water_bare terrace_falling_bare terrace_dock terrace_fog_unknown terrace_fog_peeled street_fog_known_quiet)
rc=0
